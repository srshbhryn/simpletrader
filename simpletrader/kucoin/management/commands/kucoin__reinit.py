...
from simpletrader.kucoin import configs
...
class Command(BaseCommand):
    ...
    def _reinit_assets(self):
        ...
        for spot_name, futures_name in configs.ASSETS:
    ...
    def _reinit_markets(self):
        ...
        for base_name, quote_name in configs.SPOT_MARKETS:
        ...
        for base_name, quote_name in configs.FUTURES_CONTRACTS:
